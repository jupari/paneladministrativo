    ...
    let table = $('#categorias-table').DataTable(
        {
            ...
            ajax: '/admin/admin.categoria.index',
                columns: [
...
function showCustomCargo(btn) {
    $.get("/admin/admin.categoria.edit/" + btn, (response) => {
...
function registerCategoria() {
    ...
    const route = "/admin/admin.categoria.store";
...
function updateCargo(btn) {
    const route = `/admin/admin.categoria.update/${btn}`;
