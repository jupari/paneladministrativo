            ...
            <div class="tab-pane fade" id="routing-pane" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <button class="btn btn-primary btn-block" onclick="loadRouting()" data-toggle="tooltip" title="Cargar operaciones de la orden seleccionada">
                        <i class="fas fa-search"></i> Cargar
                        </button>
                    </div>
                    <div class="col-md-2 d-flex align-items-end">
                        <button class="btn btn-success btn-block" onclick="regRouting()" data-toggle="tooltip" title="Registrar nueva operación para la orden seleccionada">
                            <i class="fas fa-plus"></i> Operación
                        </button>
                    </div>
                </div>
