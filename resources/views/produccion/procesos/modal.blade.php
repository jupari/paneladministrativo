<div class="modal fade" id="ModalProcesos" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Registrar Procesos</h4>
            ...
            <div class="modal-body">
                <form autocomplete="off">
                    ...
                    <fieldset class="border p-3 mb-4">
                        ...
                        <div class="row">
                            <input type="hidden" id="proceso_id">
                            <div class="col-md-2">
                ...
                <div class="my-3">
                    <div class="d-flex justify-content-between mb-2">
                        <button id="nuevoProceso" class="btn btn-primary btn-sm" onclick="nuevoProcesoDet()">Nuevo Registro</button>
                        <button id="actualizarProceso" class="btn btn-secondary btn-sm" onclick="actualizarProcesoDet()">Actualizar</button>
                    </div>
                    <div id="procesosdet-table"></div>
                </div>
            </div>
