        ...
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary text-white">
                <h4 class="modal-title d-flex align-items-center" id="exampleModalLabel">
                    ...
                    <span id="modal-title-text">Registrar Cliente</span>
                                ...
                                <div class="form-group">
                                    ...
                                    @if(isset($vendedorxrol) && auth()->user()->hasRole('Vendedor'))
                                        <div class="alert alert-info">
                                            <i class="fas fa-user-tie mr-2"></i>{{ $vendedorxrol->nombre_completo }} (Asignado automáticamente)
                                        </div>
            ...
            <div class="modal-footer bg-light">
                <div class="d-flex justify-content-between w-100">
                    ...
                    <div class="step-navigation">
                        <button type="button" class="btn btn-outline-primary d-none" id="prev-btn" onclick="prevStepHandler(event)">
                            <i class="fas fa-chevron-left mr-1"></i>Anterior
                        </button>
                        <button type="button" class="btn btn-primary" id="next-btn" onclick="nextStepHandler(event)">
                            Siguiente<i class="fas fa-chevron-right ml-1"></i>
                        </button>
                        <button type="button" class="btn btn-success d-none" id="finish-btn" onclick="registerCliWithFeedback()">
