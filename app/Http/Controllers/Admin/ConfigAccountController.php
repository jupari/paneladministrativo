                                    ...
                                    // if(Auth::user()->can('cuentappal.edit')){
                                        if($td->account){
                                            if($td->account->oauth_token){
                                                $href = '<button type="button" onclick="consultarCorreosCodigoAcceso(' ."'".$td->email."'". ')" class="btn btn-info btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="Ver codigo de acceso temporal "><i class="fas fa-envelope"></i></button>&nbsp';
                                                $href .= '<button type="button" onclick="consultarCorreosReestablecimiento(' ."'".$td->email."'". ')" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="Ver solicitud de restablecimiento"><i class="fas fa-key"></i></button></div>&nbsp';
                                                $href .= '<div class="d-block d-md-inline-flex"><button type="button" onclick="configToken('."'".$td->email."'".')" class="btn btn-secondary btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="Configurar el Token del correo"><i class="fas fa-cog"></i></button>';
                                            }else{
