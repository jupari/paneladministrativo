...
class NominaLiquidacionController extends Controller
{
    ...
    public function calcular(Request $request, NominaLiquidacionService $service): JsonResponse
    {
        $validated = $request->validate([
            ...
            'dias_diurnos'               => 'required|integer|min:0|max:999',
            'dias_nocturnos'             => 'nullable|integer|min:0|max:999',
            'dominicales_diurnos'        => 'nullable|integer|min:0|max:999',
            'dominicales_nocturnos'      => 'nullable|integer|min:0|max:999',
